...
IMAGE_INSTALL = "${CORE_IMAGE_BASE_INSTALL} flatbuffers zynq-fsbl git curl rsync openl2tp zeroconf cifs-utils avahi-daemon avahi-utils dtc ntp lighttpd rt-tests"
