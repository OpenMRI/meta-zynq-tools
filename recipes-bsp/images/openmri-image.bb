...
IMAGE_INSTALL = "${CORE_IMAGE_BASE_INSTALL} flatbuffers zynq-fsbl git curl rsync  cmake openvpn openl2tp zeroconf samba cifs-utils avahi-daemon avahi-utils dtc ntp lighttpd rt-tests"
